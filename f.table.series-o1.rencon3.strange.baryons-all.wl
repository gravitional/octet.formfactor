...
input`simulation={"/home/tom/octet.formfactor/f.table.series-o1.rencon3.strange.baryons-all.wl",
"o1",0.90,1.00};
...
(* ::DisplayFormula:: *)
(*data`baryons`series,{2,8,31},{gegm,io,sevater}*)
...
(* ::DisplayFormula:: *)
(*data`baryons`series,{2,8,6},{gegm,io,sevater}*)
