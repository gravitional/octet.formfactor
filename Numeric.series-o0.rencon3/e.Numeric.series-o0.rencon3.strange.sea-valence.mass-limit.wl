...
(* ::Text:: *)
(*\:5f15\:5165\:547d\:4ee4\:884c\:53c2\:6570*)
...
analytic`dir=FileNameJoin[{git`root`dir,"analytic-storage.strange.series-o0"}]
...
order++;
If[IntegerQ[order/100],Print[seva,",",io,",",if,",",coe]
];
