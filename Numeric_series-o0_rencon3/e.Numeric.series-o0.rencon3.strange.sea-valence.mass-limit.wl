...
outputAssoc=<|
(*++++++++++++++++*)
FileNameJoin[{outputDir,StringJoin["data_fit_",cFittingStr,"_rela_",errorbarQStr,"_series_",parOrderStr,"_L_",parLambda0Str,"_ci_",parciStr,".m"]}]->{dataList[1],dataList[2]}
(*++++++++++++++++*)
|>;
echo["output status"];
