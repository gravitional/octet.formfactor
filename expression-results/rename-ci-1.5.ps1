...
Copy-Item "series``o0``check``gm``total.ci-1.5.pdf" (Join-Path $tepath "fig2a.pdf")
Copy-Item "series``o1``check``ge``total.ci-1.5.pdf" (Join-Path $tepath "fig3a.pdf")
Copy-Item "series``o1``check``gm``total.ci-1.5.pdf" (Join-Path $tepath "fig4a.pdf")
